...
where Expire.TermType in ('P','C') -- Limit expires to past and current terms
and Expire.SubscriptionClass = 'R' -- Only include "regular" subscriptions
and Expire.ExpirationIssueDate >= '2016-01-01'
and Expire.OwningOrganizaion='AA'